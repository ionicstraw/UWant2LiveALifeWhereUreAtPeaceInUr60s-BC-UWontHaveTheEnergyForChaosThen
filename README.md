...
im going to sit down and lecture u on this one day but for now, and only once i'll do that, but for now, archiving this

fine ill do it now. 

the person ure with, does not have the ability to raise ur kid the way u want them to turn out -- that person is going to say "yes" to everything, looks like a random push-over to me.

to do well in STEM, u have to say "no" to a lot of things and have serious self confidence etc. theres so much more to it

u may have a situation where ur kid is running around, when ure in ur 60s, slamming doors, talking back to u and so much more, so much more that u dont even understand yet.

im not saying i want that for u, but i know what that's all about.
